...
class ValidatorsTest {
 ...
 @Test fun invalidPhoneFails(){assertNotNull(Validators.profile("Ana","ana@puce.edu.ec","12AB"))}
 ...
 @Test fun teamRequiresValidContactData(){assertNotNull(Validators.team("Halcones","Ana","correo","0999555666"));assertNotNull(Validators.team("Halcones","Ana","ana@puce.edu.ec","abc"));assertNull(Validators.team("Halcones","Ana","ana@puce.edu.ec","0999555666"))}
